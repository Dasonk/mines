...
## Soon to be part of the R package "Rgames"

## Bugs: 1) If hint is clicked after the game is won
##          the game locks up.

## Todo list:
## - Removed the block/unblock handlers from the
##   right click handler.  So we don't need the
##   ids for the handlers anymore.
##   removing these might speed up initial creation.
## - XXX:  Don't generate labels until you need to
##         or just use the buttons

## Notes:
## - Using hint as your first move will guarantee that
